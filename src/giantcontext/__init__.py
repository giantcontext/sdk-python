...
class BriefsResource(BaseResource):
    ...
    async def approve_brief(
        self, id: str, project_id: str, brief_id: str
    ) -> dict[str, Any]:
        """Approve a Mind brief

        POST /organizations/{id}/projects/{projectId}/mind/briefs/{briefId}/approve
        """
        endpoint = f"/organizations/{quote(str(id), safe='')}/projects/{quote(str(project_id), safe='')}/mind/briefs/{quote(str(brief_id), safe='')}/approve"
        return await self._request(endpoint, method="POST")

    async def reject_brief(
        self, id: str, project_id: str, brief_id: str, data: dict[str, Any]
    ) -> dict[str, Any]:
        """Reject a Mind brief

        POST /organizations/{id}/projects/{projectId}/mind/briefs/{briefId}/reject
        """
        endpoint = f"/organizations/{quote(str(id), safe='')}/projects/{quote(str(project_id), safe='')}/mind/briefs/{quote(str(brief_id), safe='')}/reject"
    ...
    async def get_brief(
        ...
        GET /organizations/{id}/projects/{projectId}/mind/briefs/{briefId}
        """
        endpoint = f"/organizations/{quote(str(id), safe='')}/projects/{quote(str(project_id), safe='')}/mind/briefs/{quote(str(brief_id), safe='')}"
        return await self._request(endpoint, method="GET")
    ...
    async def list_briefs(
        ...
        GET /organizations/{id}/projects/{projectId}/mind/briefs
        """
        endpoint = f"/organizations/{quote(str(id), safe='')}/projects/{quote(str(project_id), safe='')}/mind/briefs"
        params = {
            "page": page,
            "pageSize": page_size,
            "lite": lite,
