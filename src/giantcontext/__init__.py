...
class BugReportsResource(BaseResource):
    ...
    async def list_bug_report_comments(self, id: str) -> dict[str, Any]:
...
class BuilderResource(BaseResource):
    ...
    async def get_block_manifest(self, content_type: str) -> dict[str, Any]:
        """List the blocks available for a content type

        GET /builder/manifest
        """
        endpoint = "/builder/manifest"
        params = {
    ...
    async def get_block(self, block_type: str, content_type: str) -> dict[str, Any]:
        ...
        GET /builder/manifest/{blockType}
        """
        endpoint = f"/builder/manifest/{quote(str(block_type), safe='')}"
        params = {
            "contentType": content_type,
        }
        params = {k: v for k, v in params.items() if v is not None}
...
class DraftsResource(BaseResource):
    ...
    async def generate_edit_draft(self, data: dict[str, Any]) -> dict[str, Any]:
        """Generate a draft of changes to existing content

        POST /drafts/generate/edit
        """
        endpoint = "/drafts/generate/edit"
        return await self._request(endpoint, method="POST", json=data)

    async def generate_new_draft(self, data: dict[str, Any]) -> dict[str, Any]:
        """Generate a draft of new content

        POST /drafts/generate/new
        """
        endpoint = "/drafts/generate/new"
        return await self._request(endpoint, method="POST", json=data)

    async def create_edit_draft(self, data: dict[str, Any]) -> dict[str, Any]:
...
class FeatureRequestsResource(BaseResource):
    ...
    async def list_feature_request_comments(self, id: str) -> dict[str, Any]:
...
class MeResource(BaseResource):
    ...
    async def list_my_suspension_messages(self) -> list[dict[str, Any]]:
    ...
    async def list_my_organizations(self) -> list[dict[str, Any]]:
    ...
    async def list_my_invitations(self) -> dict[str, Any]:
...
class OrganizationsResource(BaseResource):
    ...
    async def list_service_accounts(self, organization_id: str) -> dict[str, Any]:
