...
class CRMResource(BaseResource):
    ...
    async def list_crm_company_edges(
        self,
        organization_id: str,
        project_id: str,
        app_id: str,
        ...
        GET /organizations/{organizationId}/projects/{projectId}/apps/crm/{appId}/companies/{companyId}/edges
        """
        endpoint = f"/organizations/{quote(str(organization_id), safe='')}/projects/{quote(str(project_id), safe='')}/apps/crm/{quote(str(app_id), safe='')}/companies/{quote(str(company_id), safe='')}/edges"
        params = {
            "page": page,
            "pageSize": page_size,
            "lite": lite,
...
class ChatResource(BaseResource):
    ...
    async def get_chat_conversation_timeline(
        self,
        organization_id: str,
        project_id: str,
        app_id: str,
        ...
        GET /organizations/{organizationId}/projects/{projectId}/apps/chat/{appId}/conversations/{conversationId}/timeline
        """
        endpoint = f"/organizations/{quote(str(organization_id), safe='')}/projects/{quote(str(project_id), safe='')}/apps/chat/{quote(str(app_id), safe='')}/conversations/{quote(str(conversation_id), safe='')}/timeline"
        params = {
            "page": page,
            "pageSize": page_size,
            "lite": lite,
...
class PeopleResource(BaseResource):
    ...
    async def erase_person(
        self, organization_id: str, project_id: str, person_id: str
    ) -> Any:
        """Erase a person — sever, scrub, retain

        POST /organizations/{organizationId}/projects/{projectId}/people/{personId}/erasures
        """
        endpoint = f"/organizations/{quote(str(organization_id), safe='')}/projects/{quote(str(project_id), safe='')}/people/{quote(str(person_id), safe='')}/erasures"
        return await self._request(endpoint, method="POST")
    ...
    async def set_person_field(
        ...
        PUT /organizations/{organizationId}/projects/{projectId}/people/{personId}/fields
        """
        endpoint = f"/organizations/{quote(str(organization_id), safe='')}/projects/{quote(str(project_id), safe='')}/people/{quote(str(person_id), safe='')}/fields"
        return await self._request(endpoint, method="PUT", json=data)

    async def list_person_edges(
        self,
        organization_id: str,
        project_id: str,
        person_id: str,
        ...
        GET /organizations/{organizationId}/projects/{projectId}/people/{personId}/edges
        """
        endpoint = f"/organizations/{quote(str(organization_id), safe='')}/projects/{quote(str(project_id), safe='')}/people/{quote(str(person_id), safe='')}/edges"
        params = {
            "page": page,
            "pageSize": page_size,
            "lite": lite,
    ...
    async def tag_person(
        ...
        POST /organizations/{organizationId}/projects/{projectId}/people/{personId}/tags
        """
        endpoint = f"/organizations/{quote(str(organization_id), safe='')}/projects/{quote(str(project_id), safe='')}/people/{quote(str(person_id), safe='')}/tags"
        return await self._request(endpoint, method="POST", json=data)
    ...
    async def untag_person(
        ...
        DELETE /organizations/{organizationId}/projects/{projectId}/people/{personId}/tags
        """
        endpoint = f"/organizations/{quote(str(organization_id), safe='')}/projects/{quote(str(project_id), safe='')}/people/{quote(str(person_id), safe='')}/tags"
        return await self._request(endpoint, method="DELETE", json=data)

    async def get_person_property_keys(
        self, organization_id: str, project_id: str
    ) -> dict[str, Any]:
        """Every property key the project's people carry, with counts

        GET /organizations/{organizationId}/projects/{projectId}/people/property-keys
        """
        endpoint = f"/organizations/{quote(str(organization_id), safe='')}/projects/{quote(str(project_id), safe='')}/people/property-keys"
        return await self._request(endpoint, method="GET")

    async def merge_person_property_keys(
        self, organization_id: str, project_id: str, data: dict[str, Any]
    ) -> dict[str, Any]:
        """Merge a drifted property key into its canonical name

        POST /organizations/{organizationId}/projects/{projectId}/people/property-keys
        """
        endpoint = f"/organizations/{quote(str(organization_id), safe='')}/projects/{quote(str(project_id), safe='')}/people/property-keys"
        return await self._request(endpoint, method="POST", json=data)
    ...
    async def get_person(
        ...
        GET /organizations/{organizationId}/projects/{projectId}/people/{personId}
        """
        endpoint = f"/organizations/{quote(str(organization_id), safe='')}/projects/{quote(str(project_id), safe='')}/people/{quote(str(person_id), safe='')}"
        return await self._request(endpoint, method="GET")
    ...
    async def update_person(
        ...
        PATCH /organizations/{organizationId}/projects/{projectId}/people/{personId}
        """
        endpoint = f"/organizations/{quote(str(organization_id), safe='')}/projects/{quote(str(project_id), safe='')}/people/{quote(str(person_id), safe='')}"
        return await self._request(endpoint, method="PATCH", json=data)

    async def get_person_by_email(
        self, organization_id: str, project_id: str, email: str
    ) -> dict[str, Any]:
        """Resolve a person by email address

        GET /organizations/{organizationId}/projects/{projectId}/people/by-email
        """
        endpoint = f"/organizations/{quote(str(organization_id), safe='')}/projects/{quote(str(project_id), safe='')}/people/by-email"
        params = {
            "email": email,
        }
        params = {k: v for k, v in params.items() if v is not None}
    ...
    async def identify(
        ...
        POST /organizations/{organizationId}/projects/{projectId}/people/identify
        """
        endpoint = f"/organizations/{quote(str(organization_id), safe='')}/projects/{quote(str(project_id), safe='')}/people/identify"
        return await self._request(endpoint, method="POST", json=data)
    ...
    async def list_erasures(
        ...
        GET /organizations/{organizationId}/projects/{projectId}/erasures
        """
        endpoint = f"/organizations/{quote(str(organization_id), safe='')}/projects/{quote(str(project_id), safe='')}/erasures"
        params = {
            "page": page,
            "pageSize": page_size,
            "lite": lite,
    ...
    async def list_people(
        ...
        GET /organizations/{organizationId}/projects/{projectId}/people
        """
        endpoint = f"/organizations/{quote(str(organization_id), safe='')}/projects/{quote(str(project_id), safe='')}/people"
        params = {
            "page": page,
            "pageSize": page_size,
            "lite": lite,
    ...
    async def create_person(
        ...
        POST /organizations/{organizationId}/projects/{projectId}/people
        """
        endpoint = f"/organizations/{quote(str(organization_id), safe='')}/projects/{quote(str(project_id), safe='')}/people"
        return await self._request(endpoint, method="POST", json=data)
    ...
    async def track(
        ...
        POST /organizations/{organizationId}/projects/{projectId}/edges
        """
        endpoint = f"/organizations/{quote(str(organization_id), safe='')}/projects/{quote(str(project_id), safe='')}/edges"
        return await self._request(endpoint, method="POST", json=data)
...
class GiantContext:
    ...
    def __init__(self, config: GiantContextConfig):
        ...
        self.people = PeopleResource(self._client)
